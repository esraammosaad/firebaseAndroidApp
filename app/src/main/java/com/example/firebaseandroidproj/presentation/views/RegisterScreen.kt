    ...
    override fun Content() {
        ...
        LazyColumn(
            ...
            item {
                ...
                CustomButton(text = stringResource(id = R.string.signup), onClick = {
                    viewModel.register(
                ...
                RichText(stringResource(id = R.string.already), stringResource(id = R.string.login)) { offset ->
                    if (offset in 25..38) {
                        navigator.pop()
                    }
                }
                CustomAuthMethodContainer(text = "Signup with Facebook", icon = R.drawable.facebook, onClick = {})
                CustomAuthMethodContainer(text = "Signup with Google", icon = R.drawable.google, onClick = {
                    lifecycleOwner.lifecycleScope.launch {
